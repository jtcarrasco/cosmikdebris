---
title: "Welcome to the Workshop (Where Things Occasionally Work)"
...
The name is a [Frank Zappa song](https://www.youtube.com/watch?v=rK3BKZVF1Hg), and also an accurate description of how my project folders look at any given moment. Years of building and breaking things generates a lot of fragments: a half-finished config, a script that works but nobody knows why, three different ways of solving the same problem. Eventually some of it coheres into something actually useful.

This site is my attempt to capture that stuff before it disappears into the void. Documentation for future me, who will absolutely forget how he solved that one obscure systemd problem.

If you want to see how this site itself came together (it's a good story), check out [building a Jekyll site with AI](/posts/building-a-site-with-ai/).
...
I learn by doing, which means I also learn by doing it wrong first. This blog reflects that. I won't pretend the first version worked, or that I knew what I was doing from the start. The goal is honest documentation of the process, including the parts where I had to look something up four times before it finally stuck.

Quality over posting schedule. I'd rather write one useful thing than ten things that waste your time.
